      ...
      try {
        ...
        if (response.ok) {
          ...
          const cricketVenues = data.filter((venue) =>
            venue.groundname.toLowerCase().includes('basketball')
          );
    ...
    <div className="venue-section2">
      ...
      <div className="venue-section">
        <div className="venue-header2">
          <h2 className="venue-heading2">Book Basketball Venues</h2>
        </div>
...
export default BasketballVenue;